...
import type { ApprovalRequest, PendingToolCall } from '../src/core/hooks'
import type { AgentState, ApprovalDecision, ApprovalHistoryEntry } from '../src/core/state'
import { startState, withApprovals } from '../src/core/state'
