...
export class StreamOptions extends Schema.Class<StreamOptions>('LLM.StreamOptions')({
	...
	productiveFirstEventTimeoutMs: Schema.optional(Schema.Number),
	productiveEventIdleWarningMs: Schema.optional(Schema.Number),
	...
	const result = Object.fromEntries(
		defined.flatMap((item) =>
			Object.entries({
				...
				productiveFirstEventTimeoutMs: item.productiveFirstEventTimeoutMs,
				productiveEventIdleWarningMs: item.productiveEventIdleWarningMs,
